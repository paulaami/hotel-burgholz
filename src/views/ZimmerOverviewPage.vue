						...
						<router-link :to="'/zimmer/' + key" class="room-image-link">
							<div class="room-image">
								...
								<div class="room-overlay">
									<span class="room-category" v-if="room.category">{{
										room.category
									}}</span>
...
const rooms = {
	einzelzimmer: {
		...
		description:
			"Unser Einzelzimmer, ist ideal für Geschäftsreisende und Radfahrer, bietet eine helle und gemütliche Atmosphäre auf etwa 16 m². Ausgestattet mit einer Klimaanlage sorgt es für angenehme Temperaturen.",
		capacity: "1 Person",
		price: "Ab 112,– / Nacht",
		size: "16 m²",
	},
	doppelzimmer: {
		...
		description:
			"Das Doppelzimmer bietet eine helle und gemütliche Atmosphäre auf etwa 25 m². Mit Klimaanlage, Schreibtisch, Flat-TV und kostenfreiem WLAN mit Glasfaseranschluss für schnelle Internetverbindungen.",
		capacity: "2 Personen",
		price: "Ab 140,– / Nacht",
		size: "25 m²",
	},
	apartment: {
		...
		description:
			"Die Apartments bieten für zwei Personen eine komfortable Unterkunft auf 36 m². Jedes Apartment verfügt über separate Schlafzimmer, die Privatsphäre und Ruhe gewährleisten.",
		capacity: "2 Personen",
		price: "Ab 160,– / Nacht",
		size: "36 m²",
	},
...
.hero-section {
	...
	height: 60vh;
	min-height: 400px;
	background-image: url("@/assets/images/doppelzimmer/Hotel Burgholz_Uschi Kitschke Fotografie-27.jpg");
